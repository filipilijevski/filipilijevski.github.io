    ...
    <>
      ...
      <section id="about" className="about-section">
        <div className="container">
          ...
          />
          <p>
            Hi! I am <strong>Filip Ilijevski</strong>, a computer-science
            student who loves turning complex workflows into responsive,
            intuitive experiences.
          </p>
          <h3 className="fw-bold mt-4 mb-3">How I Work</h3>
          <p>
            I primarly use <strong>React.js, Spring, PostgreSQL </strong> and{' '}
            <strong>Express.js</strong> for rapid, responsive full-stack app development.
             Most of my prototypes are done in Figma and validated with{' '}
            <a
